...
```
cd existing_repo
git remote add origin https://gitlab.com/hilmiat/pjj_angular_2023.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/hilmiat/pjj_angular_2023/-/settings/integrations)
